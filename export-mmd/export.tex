...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, titlerule=0mm, coltitle=black, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, opacityback=0, colframe=quarto-callout-warning-color-frame, breakable, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, toptitle=1mm, arc=.35mm, toprule=.15mm, rightrule=.15mm, bottomrule=.15mm, colback=white, leftrule=.75mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, titlerule=0mm, coltitle=black, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, opacityback=0, colframe=quarto-callout-caution-color-frame, breakable, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, toptitle=1mm, arc=.35mm, toprule=.15mm, rightrule=.15mm, bottomrule=.15mm, colback=white, leftrule=.75mm, opacitybacktitle=0.6]
