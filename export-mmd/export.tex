...
\caption{\label{fig-scriv146}\enquote{\emph{What a trip!}} - said
...
\protect\hypertarget{cite_4}{}{\label{cite_4}Figure~\ref{fig-scriv146}})!
...
\caption{\label{tbl-scriv146}This is native Scrivener table with a
...
\chapter{Methods}\label{sec-scriv147}}

\hypertarget{sec-scriv148}{%
\section{Data Recording}\label{sec-scriv148}}
...
\caption{\label{fig-scriv148}A figure of a poor, poor marginalised
elephant\ldots{}}
...
\section{Experimental Perturbations}\label{sec-scriv150}}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame, colback=white, opacitybacktitle=0.6, arc=.35mm, left=2mm, toptitle=1mm, toprule=.15mm, titlerule=0mm, coltitle=black, bottomtitle=1mm, leftrule=.75mm, opacityback=0]
...
{\centering \includegraphics{export_files/figure-pdf/fig-scriv151-1.pdf}

}

\caption{\label{fig-scriv151}A plot generated at compile-time by R,
...
\section{Statistical Analysis}\label{sec-scriv154}}
...
\label{fig-scriv154}A graphviz graph with figure reference and caption,
...
\caption{\label{fig-scriv159}This figure uses custom metadata values to
...
\hypertarget{sec-scriv160}{%
\chapter{Results}\label{sec-scriv160}}

\hypertarget{sec-scriv161}{%
\section{Lunar Cycles}\label{sec-scriv161}}
...
\caption{\label{fig-scriv162}This should span the page to the right in
...
\caption{\label{tbl-scriv164}This is a markdown multi-table panel with
...
\caption{\label{fig-scriv166}This demonstrates generating a multi-panel
...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, colbacktitle=quarto-callout-caution-color!10!white, colframe=quarto-callout-caution-color-frame, colback=white, opacitybacktitle=0.6, arc=.35mm, left=2mm, toptitle=1mm, toprule=.15mm, titlerule=0mm, coltitle=black, bottomtitle=1mm, leftrule=.75mm, opacityback=0]
...
\chapter{Changes}\label{sec-scriv173}}
...
\hypertarget{sec-scriv174}{%
\section{Cross-referencing}\label{sec-scriv174}}

\protect\hypertarget{scriv174}{}{}
...
\begin{conjecture}[]\protect\hypertarget{cnj-scriv176}{}\label{cnj-scriv176}
...
\begin{corollary}[]\protect\hypertarget{cor-scriv177}{}\label{cor-scriv177}

Corollary content

\end{corollary}

\begin{definition}[]\protect\hypertarget{def-scriv178}{}\label{def-scriv178}

Definition content

\end{definition}

\begin{example}[]\protect\hypertarget{exm-scriv179}{}\label{exm-scriv179}
...
\begin{lemma}[]\protect\hypertarget{lem-scriv181}{}\label{lem-scriv181}

Lemma content

\end{lemma}

\begin{proposition}[]\protect\hypertarget{prp-scriv182}{}\label{prp-scriv182}
...
\hypertarget{sec-scriv184}{%
\subsection{eq, lst, fig, tbl}\label{sec-scriv184}}
...
\hypertarget{sec-scriv189}{%
\subsection{Cite Field}\label{sec-scriv189}}
...
\protect\hypertarget{scriv191}{}{} \textsc{New} \textbf{Styles} provide
...
\protect\hypertarget{scriv193}{}{} Later, the \emph{De Anima} was edited
...
\caption{\label{tbl-scriv194}Simple example of how we are using styles
...
This allows us to create links to \protect\hyperlink{scriv195}{text
sections that do not have a Header element}.

\protect\hypertarget{scriv196}{}{} Belive it or not, Scrivener can be an
...
\caption{\label{fig-scriv196}Revising code in Scrivener can be just as
pleasant}
...
\caption{\label{fig-scriv197}Students finishing their MDs or PhDs will
...
\chapter{Primary Sources}\label{sec-scriv200}}
...
\hypertarget{sec-scriv201}{%
\chapter{Secondary Sources}\label{sec-scriv201}}

\hypertarget{refs_scriv201}{}
\begin{CSLReferences}{0}{1}
...
\hypertarget{sec-scriv202}{%
\chapter{Workflow}\label{sec-scriv202}}

\hypertarget{refs_scriv202}{}
\begin{CSLReferences}{0}{1}
