...
\begin{tcolorbox}[enhanced jigsaw, breakable, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, opacityback=0, arc=.35mm, left=2mm, bottomtitle=1mm, toptitle=1mm, toprule=.15mm, titlerule=0mm, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, colback=white, rightrule=.15mm, bottomrule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, opacitybacktitle=0.6, colframe=quarto-callout-caution-color-frame, opacityback=0, arc=.35mm, left=2mm, bottomtitle=1mm, toptitle=1mm, toprule=.15mm, titlerule=0mm, coltitle=black, colbacktitle=quarto-callout-caution-color!10!white, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, colback=white, rightrule=.15mm, bottomrule=.15mm, leftrule=.75mm]
