...
Results{]}{[}Lunar Cycles \{\#sec-scriv169\}{]}) , est mægna alienum
mentitum ne. \href{https://quarto.org/}{Amet equidem} sit ex ({[}see
Conclusion{]}{[}Discussion \{\#sec-scriv176\}{]}). Ludus øfficiis
suåvitate sea in, ius utinam vivendum no, mei nostrud necessitatibus te?
...
\caption{\label{fig-scriv154}\enquote{\emph{What a trip!}} - said
...
\protect\hypertarget{cite_4}{}{\label{cite_4}Figure~\ref{fig-scriv154}})!
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacitybacktitle=0.6, bottomtitle=1mm, coltitle=black, opacityback=0, colback=white, colbacktitle=quarto-callout-tip-color!10!white, toptitle=1mm, bottomrule=.15mm, toprule=.15mm, breakable, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, arc=.35mm, colframe=quarto-callout-tip-color-frame, titlerule=0mm, rightrule=.15mm, leftrule=.75mm]
...
\protect\hypertarget{cite_8}{}{\label{cite_8}Table~\ref{tbl-scriv154}}
for more details.

\hypertarget{tbl-scriv154}{}
\begin{longtable}[]{@{}lll@{}}
\toprule\noalign{}
...
\caption{\label{tbl-scriv154}This is native Scrivener table with a
...
See both
\protect\hypertarget{cite_9}{}{\label{cite_9}Equation~\ref{eq-scriv156}}
and
\protect\hypertarget{cite_10}{}{\label{cite_10}Equation~\ref{eq-scriv157}}
for more details:
...
\section{Experimental Perturbations}\label{sec-scriv158}}

\protect\hypertarget{scriv158}{}{}
...
\protect\hypertarget{cite_14}{}{\label{cite_14}Figure~\ref{fig-scriv174}}below
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacitybacktitle=0.6, bottomtitle=1mm, coltitle=black, opacityback=0, colback=white, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, bottomrule=.15mm, toprule=.15mm, breakable, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, arc=.35mm, colframe=quarto-callout-warning-color-frame, titlerule=0mm, rightrule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacitybacktitle=0.6, bottomtitle=1mm, coltitle=black, opacityback=0, colback=white, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, bottomrule=.15mm, toprule=.15mm, breakable, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, arc=.35mm, colframe=quarto-callout-important-color-frame, titlerule=0mm, rightrule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacitybacktitle=0.6, bottomtitle=1mm, coltitle=black, opacityback=0, colback=white, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, bottomrule=.15mm, toprule=.15mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, arc=.35mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, rightrule=.15mm, leftrule=.75mm]
...
Here is an R plot
(\protect\hypertarget{cite_18}{}{\label{cite_18}Figure~\ref{fig-scriv159}}),
...
{\centering \includegraphics{export_files/figure-pdf/fig-scriv159-1.pdf}

}

\caption{\label{fig-scriv159}A plot generated at compile-time by R,
...
Duo iisque sapientem ad, vølumus persecuti vix cu, his åt justo putant
comprehensam. See
\protect\hypertarget{cite_19}{}{\label{cite_19}Figure~\ref{fig-scriv163}}
and
\protect\hypertarget{cite_20}{}{\label{cite_20}Figure~\ref{fig-scriv165}}
for details.
...
Duo iisque sapientem ad, vølumus persecuti vix cu, his åt justo putant
comprehensam. See
\protect\hypertarget{cite_22}{}{\label{cite_22}Figure~\ref{fig-scriv167}}
for details.
...
\caption{\label{fig-scriv167}This figure uses custom metadata values to
...
\chapter{Results}\label{sec-scriv168}}

\hypertarget{sec-scriv169}{%
\section{Lunar Cycles}\label{sec-scriv169}}

\protect\hypertarget{scriv169}{}{}
...
\caption{\label{fig-scriv170}This should span the page to the right in
...
eloquentiåm ei mei. In pri solet soleat timeam, tale possit vis æt.
Please refer to
\protect\hypertarget{cite_29}{}{\label{cite_29}Table~\ref{tbl-scriv172}},
including
...
\caption{\label{tbl-scriv172}This is a markdown multi-table panel with
...
\section{Solar Cycles}\label{sec-scriv173}}
...
instead of using raw markdown as {[}shown here{]}{[}Experimental
Perturbations \{\#sec-scriv158\}{]}. ID, Class and Attributes specific
to the block
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacitybacktitle=0.6, bottomtitle=1mm, coltitle=black, opacityback=0, colback=white, colbacktitle=quarto-callout-caution-color!10!white, toptitle=1mm, bottomrule=.15mm, toprule=.15mm, breakable, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, arc=.35mm, colframe=quarto-callout-caution-color-frame, titlerule=0mm, rightrule=.15mm, leftrule=.75mm]
...
sea in, ius utinam vivendum no (see {[}Introduction{]}{[}Introduction
\{\#sec-scriv154\}{]}), mei nostrud necessitatibus te?
...
\begin{equation}\protect\hypertarget{eq-scriv177}{}{\frac{d}{dx}\left( \int_{a}^{x} f(u)\,du\right)=f(x).}\label{eq-scriv177}\end{equation}
...
thread}, and \href{https://forum.literatureandlatte.com/t/134755}{this
thread}).
...
Meta Fields}, YAML Parameters for Quarto, new icons and more.\footnote{See
  \href{https://www.stockio.com/}{https://www.stockio.com}.} If you
already have Quarto and R working installations, it introduces
\textbf{zero} new dependencies and you should be able to compile it
right away. Please, go ahead and try it. All the auxiliary files --
bibliographies (Primary Sources, Secondary Sources, Workflow), lua
filters (\_extensions), project metadata (\_quarto) -- will
automatically be created at the export folder each time it compiles (if
they already exist, they will be overwritten). The \emph{only} external
dependencies, therefore, are Quarto and R.
...
I included \emph{nearly} every option for
\href{https://quarto.org/docs/reference/projects/books.html}{Quarto
Books} and
\href{https://quarto.org/docs/reference/projects/websites.html}{Websites},
...
head over to \href{https://github.com/sponsors/bcdavasconcelos}{Github
Sponsors} (github.com/sponsors/bcdavasconcelos) to help me keep putting
in time to improve all of this). Naturally, I have \textbf{not} tested
all of them yet, but as you learn more about each parameter, you can add
notes to the \texttt{synopsis} and \texttt{notes} fields to keep track
of how it affects our document or project. In time, this will make it
much easier for you to understand what each option is for and revert
...
\section{Cross-referencing}\label{sec-scriv182}}
...
\protect\hypertarget{cite_37}{}{\label{cite_37}\protect\hyperlink{ref-cnj}{\textbf{cnj?}}{[}cnj,
cor, def, exm, exr, lem, prp, thm \{\#sec-scriv183\}{]}},
\protect\hypertarget{cite_38}{}{\label{cite_38}\protect\hyperlink{ref-cor}{\textbf{cor?}}{[}cnj,
cor, def, exm, exr, lem, prp, thm \{\#sec-scriv183\}{]}},
\protect\hypertarget{cite_39}{}{\label{cite_39}\protect\hyperlink{ref-def}{\textbf{def?}}{[}cnj,
cor, def, exm, exr, lem, prp, thm \{\#sec-scriv183\}{]}},
\protect\hypertarget{cite_40}{}{\label{cite_40}\protect\hyperlink{ref-exm}{\textbf{exm?}}{[}cnj,
cor, def, exm, exr, lem, prp, thm \{\#sec-scriv183\}{]}},
\protect\hypertarget{cite_41}{}{\label{cite_41}\protect\hyperlink{ref-exr}{\textbf{exr?}}{[}cnj,
cor, def, exm, exr, lem, prp, thm \{\#sec-scriv183\}{]}},
\protect\hypertarget{cite_42}{}{\label{cite_42}\protect\hyperlink{ref-lem}{\textbf{lem?}}{[}cnj,
cor, def, exm, exr, lem, prp, thm \{\#sec-scriv183\}{]}},
\protect\hypertarget{cite_43}{}{\label{cite_43}\protect\hyperlink{ref-prp}{\textbf{prp?}}{[}cnj,
cor, def, exm, exr, lem, prp, thm \{\#sec-scriv183\}{]}},
\protect\hypertarget{cite_44}{}{\label{cite_44}\protect\hyperlink{ref-thm}{\textbf{thm?}}{[}cnj,
cor, def, exm, exr, lem, prp, thm \{\#sec-scriv183\}{]}}.
...
\protect\hypertarget{cite_45}{}{\label{cite_45}Conjecture~\ref{cnj-scriv184}},
\protect\hypertarget{cite_46}{}{\label{cite_46}Corollary~\ref{cor-scriv185}},
\protect\hypertarget{cite_47}{}{\label{cite_47}Definition~\ref{def-scriv186}},
\protect\hypertarget{cite_48}{}{\label{cite_48}Example~\ref{exm-scriv187}},
\protect\hypertarget{cite_49}{}{\label{cite_49}Exercise~\ref{exr-scriv188}},
\protect\hypertarget{cite_50}{}{\label{cite_50}Lemma~\ref{lem-scriv189}},
\protect\hypertarget{cite_51}{}{\label{cite_51}Proposition~\ref{prp-scriv190}},
\protect\hypertarget{cite_52}{}{\label{cite_52}Theorem~\ref{thm-scriv191}}.

\begin{conjecture}[]\protect\hypertarget{cnj-scriv184}{}\label{cnj-scriv184}
...
\begin{corollary}[]\protect\hypertarget{cor-scriv185}{}\label{cor-scriv185}

Corollary content

\end{corollary}

\begin{definition}[]\protect\hypertarget{def-scriv186}{}\label{def-scriv186}

Definition content

\end{definition}

\begin{example}[]\protect\hypertarget{exm-scriv187}{}\label{exm-scriv187}

Example content

\end{example}

\begin{exercise}[]\protect\hypertarget{exr-scriv188}{}\label{exr-scriv188}

Exercise content

\end{exercise}

\begin{lemma}[]\protect\hypertarget{lem-scriv189}{}\label{lem-scriv189}

Lemma content

\end{lemma}

\begin{proposition}[]\protect\hypertarget{prp-scriv190}{}\label{prp-scriv190}

Proposition content

\end{proposition}

\begin{theorem}[]\protect\hypertarget{thm-scriv191}{}\label{thm-scriv191}
...
\subsection{eq, lst, fig, tbl}\label{sec-scriv192}}

\protect\hypertarget{scriv192}{}{}

Notice that we can always use the same strategy with regular labels
(\protect\hypertarget{cite_53}{}{\label{cite_53}Equation~\ref{eq-scriv192}},
\protect\hypertarget{cite_54}{}{\label{cite_54}Figure~\ref{fig-scriv192}},
\protect\hypertarget{cite_55}{}{\label{cite_55}Listing~\ref{lst-scriv192}},
\protect\hypertarget{cite_56}{}{\label{cite_56}Table~\ref{tbl-scriv192}}).
...
And see also
\protect\hypertarget{cite_57}{}{\label{cite_57}Equation~\ref{eq-scriv193}},
\protect\hypertarget{cite_58}{}{\label{cite_58}Table~\ref{tbl-scriv194}}.\\
...
Layout} \& \textbf{Section Type} provide support for the
...
\hypertarget{sec-scriv197}{%
\subsection{Cite Field}\label{sec-scriv197}}

\protect\hypertarget{scriv197}{}{}
...
\protect\hypertarget{scriv199}{}{} \textsc{New} \textbf{Styles} provide
support for the \href{https://github.com/bcdavasconcelos/citefield}{cite
field} Lua Filter, which can be used to cite arbitrary fields of the
references.
...
\protect\hypertarget{scriv201}{}{} Later, the \emph{De Anima} was edited
...
\caption{\label{tbl-scriv202}Simple example of how we are using styles
...
This allows us to create links to \protect\hyperlink{scriv203}{text
sections that do not have a Header element}.

\protect\hypertarget{scriv204}{}{} Belive it or not, Scrivener can be an
...
\caption{\label{fig-scriv204}Revising code in Scrivener can be just as
pleasant}

\end{figure}

\protect\hypertarget{scriv205}{}{}
...
\caption{\label{fig-scriv205}Students finishing their MDs or PhDs will
...
\protect\hypertarget{scriv208}{}{} Bootstrap Icons -
\url{https://icons.getbootstrap.com} - These are available in Quarto
documents using the \textbf{Shortcode Font Awesome} style as in
...
(\url{https://github.com/iandol/scrivomatic\#writing-in-scrivener}) is a
must read. The Plain Person's Guide to Plain Text Social Science -
\url{https://plain-text.co/index.html\#introduction} Quarto Reference -
\url{https://quarto.org/docs/reference/} The easiest way to publish to
Github Pages:
...
\textbf{?env:QUARTO\_PROJECT\_DIR \textgreater\}\}}
...
\hypertarget{sec-scriv209}{%
\chapter{Primary Sources}\label{sec-scriv209}}

\hypertarget{refs_scriv209}{}
...
\chapter{Secondary Sources}\label{sec-scriv210}}
...
\chapter{Workflow}\label{sec-scriv211}}
