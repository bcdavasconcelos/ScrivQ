...
Deleting [Cite Tools](https://bcdavasconcelos.github.io/citetools) from ScrivQ will cause the compilation to [fail]{.underline}.
:::
...
1. Type [your-keyword-of-choice]{.underline} or `s\crivlink`, select it, and hit [Command + L]{.underline};
2. Link to the document that contains the table.
3. Apply a **Character Style** called *Cite*.
:::
...
Table: This table with with a passage from John 1.1 uses the **Section Type**  [Text]{.underline} and **Paragraph Style** [Table Caption]{.underline}.  {#tbl-demo-a}
