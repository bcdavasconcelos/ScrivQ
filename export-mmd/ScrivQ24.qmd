...
There is no need to keep **separate bibliography files** in the system. Simply **copy and paste the references directly to Scrivener**. Follow the instructions below.
:::
...
To reference elements created from **Raw Markup** or **Character Style**, use the actual given `ID` (*e.g.* `fig-ulysses`).
:::
