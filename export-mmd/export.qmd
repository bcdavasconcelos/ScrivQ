...
![This figure uses custom metadata values to identify the class, ID, width and height. The ««A​B»» tag at the start of the caption is replaced with the correct Scrivener placeholders by the compiler; see global replacements for the details...](Ulysses1.jpg){#fig-scriv164 .column-page width=537 height=444}
...
:::{.column-page-right}
![This should span the page to the right in HTML. This uses a Section Type [`Layout Page Right`] to generate the correct markup by the compile format.](Elephant3.jpg){#fig-scriv167 width=506 height=411}
...
![Revising code in Scrivener can be just as pleasant](scrivenerwithcode.png){#fig-scriv202 width=554 height=346}
...
![Students finishing their MDs or PhDs will certainly appreciate the possibility of adding your own latex customizations, which can also be done by including the code within certain fields, such as before-body.](pandocquartolatextemplate.png){#fig-scriv203 .column-page width=547 height=342}
